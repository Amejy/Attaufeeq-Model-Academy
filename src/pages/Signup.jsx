...
function Signup() {
  ...
  return (
    <main className="section-wrap py-16">
      <div className="glass-card interactive-card mx-auto max-w-md p-6">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              to="/admissions"
              className="interactive-button rounded-2xl bg-primary px-4 py-3 text-center text-sm font-semibold text-white hover:bg-emerald-800"
            >
              Start Admission
            </Link>
            <Link
              to="/login/parent"
              className="interactive-button rounded-2xl border border-slate-300 px-4 py-3 text-center text-sm font-semibold text-slate-700 hover:bg-slate-50"
            >
              Parent Login
            </Link>
          </div>
        ...
        <p className="mt-6 break-words text-center text-sm text-slate-600">
          ...
          <Link to="/login/parent" className="interactive-link font-semibold text-primary hover:underline">
            Log in here
          </Link>
        </p>
      </div>
