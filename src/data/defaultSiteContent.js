export const defaultSiteContent = {
  branding: {
    ...
    intro:
      'ATTAUFEEQ Model Academy is a modern educational institution committed to nurturing excellence in both Western and Islamic education.',
  ...
  academics: {
    ...
    curriculumText:
      "ATTAUFEEQ Model Academy follows national educational standards including WAEC and NECO preparation."
  },
  staff: {
    title: 'Staff and Teachers',
    intro: 'Meet the educators and staff who support academic growth and student care.',
    featuredStaff: []
  },
  gallery: {
    title: 'Gallery',
  ...
  madrasa: {
    ...
    modules: [
      { title: "Qur'an Memorization", text: 'Structured memorization goals with progress tracking and revision cycles.' },
      { title: 'Tajweed', text: "Guided pronunciation and recitation standards for accurate Qur'anic reading." },
      { title: 'Arabic Language', text: 'Foundational to intermediate Arabic for comprehension, writing, and communication.' },
      { title: 'Islamic Studies', text: 'Core teachings in Aqeedah, Fiqh, Seerah, and Islamic character development.' }
    ]
  },
  contact: {
    title: 'Contact',
