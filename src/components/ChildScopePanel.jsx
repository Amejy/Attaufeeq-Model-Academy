          ...
          return (
            ...
            >
              <div className="flex flex-col items-start gap-3 sm:flex-row sm:justify-between">
                <div className="min-w-0">
                  <p className="text-truncate-2 text-base font-semibold leading-snug sm:text-lg" title={child.fullName}>{child.fullName}</p>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl bg-slate-50 px-3 py-3">
                  ...
                  <p className="text-wrap-safe mt-2 text-sm font-medium">{child.institution || 'Unassigned'}</p>
                </div>
                <div className="rounded-2xl bg-slate-50 px-3 py-3">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">Student Code</p>
                  <p className="text-code-break mt-2 text-sm font-medium">{buildStudentCode(child)}</p>
                </div>
              </div>
            </article>
          );
